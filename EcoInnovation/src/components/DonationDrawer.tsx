        ...
        >
            <Container>
                <Stack>
                    ...
                    />
                    <Paper {...paperProps}>
                        <Text fw={500}>Tip EcoInnovation services</Text>
                        <Text size="sm" my="xs">EcoInnovation has a 0% platform fee for organizers. EcoInnovation will continue
                            ...
                            {(styles) =>
                                ...
                                >
                                    <Stack sx={{width: '100%'}}>
                                        ...
                                        <Checkbox label="Save card for future investments"/>
                                    </Stack>
                                </Paper>
                            }
                        </Transition>
                    ...
                    <Paper {...paperProps}>
                        <Stack>
                            <Group spacing={4}>
                                <Checkbox label="Don't display my name publicly on the project list."/>
                    ...
                    <Paper {...paperProps}>
                        <Stack>
                            <Text fw={700} size="lg">Your investment</Text>
                            <Group position="apart">
                                <Text>Your investment</Text>
                                <Text fw={500}>₹0.00</Text>
                            </Group>
                            <Group position="apart">
                                <Text>EcoInnovation tip</Text>
                                <Text fw={500}>₹0.00</Text>
                            </Group>
                            <Group position="apart">
                    ...
                    <Paper {...paperProps}>
                        <Stack>
                            <Text size="sm">By continuing, you agree with <Anchor>EcoInnovation terms</Anchor> and <Anchor>privacy
                                notice.</Anchor></Text>
                            ...
                            <Flex gap="sm">
                                ...
                                <Text size="sm">We guarantee you a full refund for up to a year in the rare case that
                                    fraud occurs.&nbsp;<Anchor>See our EcoInnovation Giving Guarantee.</Anchor>
                                </Text>
                            </Flex>
                        </Stack>
                    </Paper>

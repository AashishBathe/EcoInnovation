...
import { BrandName } from "./index.ts";
    ...
    return (
        <footer className={classes.footer}>
            <Container className={classes.inner} size="lg">
                <div className={classes.logo}>
                    <Stack align="flex-start">
                        <BrandName size={40} asLink />
                        <Text size="sm">EcoInnovation supports sustainable energy through partnerships with leading organizations and governments.
                            We offer investment opportunities in established projects.
                            Join us and be part of a community driving sustainable solutions.
                        </Text>
                    </Stack>
                </div>
            ...
            <Container className={classes.afterFooter} size="lg">
                <Text size="sm">
                    © {new Date().getFullYear()} EcoInnovation. All rights reserved.
                </Text>

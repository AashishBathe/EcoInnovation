        ...
        <Box {...boxProps}>
            <Flex align="center" gap={{ base: 'sm', sm: 'lg' }} direction={{ base: 'column-reverse', sm: 'row' }}>
                <Stack align={matchesMobile ? 'center' : 'stretch'}>
                    ...
                    <Flex gap="sm">
                        <Button size="lg" variant="filled" style={{ backgroundColor: "#DAA520" }} component={Link} to="/create-campaign">Make Project
                        </Button>
                        <Button size="lg" variant="outline" style={{ color: "#DAA520", borderColor: "#DAA520" }} component={Link} to="/how-it-works">How it Works</Button>
                    </Flex>
                </Stack>

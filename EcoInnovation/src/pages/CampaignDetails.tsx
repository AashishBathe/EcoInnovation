                                    ...
                                    <Stack mt="md">
                                        ...
                                        {matchesMobile && <>
                                            ...
                                            <Flex align="center" gap="xs">
                                                <Button onClick={donateOpen} fullWidth>Invest</Button>
                                                <ActionIcon
                                                    variant="subtle"
                                                    onClick={open}
                                                    color="blue"
                                ...
                                {!matchesMobile &&
                                    <Paper {...paperProps}>
                                        <Stack spacing="sm">
                                            ...
                                            <Button size="xl" onClick={donateOpen}>Invest</Button>
                                            <Button
                                ...
                                <Paper {...paperProps}>
                                    ...
                                    <Accordion defaultValue="customization" variant="separated">
                                        <Accordion.Item value="customization">
                                            ...
                                            <Accordion.Panel>Your payment is sent directly to the Organization so it immediately
                                                helps
